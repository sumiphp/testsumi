                                              ...
                                              <span id="msg"></span><br>
                                                <div id="data-source-1_wrapper" class="dataTables_wrapper">
                                                  ...
                                                  <tr role="row" class="odd" id="<?php echo $res['newsletterid'];?>" >
                                                      <td class="sorting_1"><?php echo $res['newsletterdescription'];?></td>
                                                      
                                                      <td> 
                                                        <ul class="action"> 
                                                          <li class="edit"> <a href="<?php echo base_url().'Welcome/editnewsletter/'.$res['newsletterid'];?>"  data-bs-original-title="" title=""><i class='bx bx-edit'></i></a></li>
                                                          <!--<li class="delete"><a href="#" onclick="deltestimonials(<?php //echo $res['newsletterid'];?>)" data-bs-original-title="" title=""><i class='bx bx-trash'></i></a></li>-->
