                                            ...
                                            <div class="inner-card-body">
                                              ...
                                              <span id="msg"></span><?php echo $this->session->flashdata('flash_msg');?><br><br>
                                                <div id="data-source-1_wrapper" class="dataTables_wrapper">
                                                  ...
                                                  <thead>
                                                    <tr role="row">
                                                      <th class="sorting_asc" tabindex="0" aria-controls="data-source-1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 350px;">Aboutcompany</th>
                                                      ...
                                                      <th class="sorting" tabindex="0" aria-controls="data-source-1" rowspan="1" colspan="1" aria-label="Salary: activate to sort column ascending" style="width: 220px;">Mission</th>
                                                                              ...
                                                                              <th class="sorting" tabindex="0" aria-controls="data-source-1" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 142px;">yearsexperience</th>
                                                                              <th class="sorting" tabindex="0" aria-controls="data-source-1" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 142px;">projectsdone</th>
                                                                              <th class="sorting taC" tabindex="0" aria-controls="data-source-1" rowspan="1" colspan="1" aria-label="Action: activate to sort column ascending" style="width: 151px;">happyclients</th>
                                                  ...
                                                  <tr role="row" class="odd" id="<?php echo $res['aboutusid'];?>" >
                                                      ...
                                                      <td><?php echo $res['yearsexperience'];?></td>
                                                      <td><?php echo $res['projectsdone'];?></td>
                                                      <td><?php echo $res['happyclients']?></td>
