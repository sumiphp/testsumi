                                                ...
                                                <div id="data-source-1_wrapper" class="dataTables_wrapper">
                                                  ...
                                                  <thead>
                                                    <tr role="row">
                                                      ...
                                                      <th class="sorting" tabindex="0" aria-controls="data-source-1" rowspan="1" colspan="1" aria-label="Salary: activate to sort column ascending" style="width:420px;">Solution Title</th>
                                                  ...
                                                  <tr role="row" class="odd" id="<?php echo $result->servicedtid;?>" >
                                                      <td class="sorting_1"><?php echo $result->servicedttitle;?></td>
                                                      <!--<td>Indoor Lamps</td>-->
                                                      <td><?php echo $result->servicedtsolution;?></td>
                                                    ...
                                                    <img src="<?php //echo base_url().'uploads/blog/'.$res['autorimage'];?>" />
                                                      ...
                                                      <td> 
                                                        <ul class="action"> 
                                                          <li class="edit"> <a href="<?php echo base_url().'Welcome/editservicedetails/'.$result->servicedtid;?>" data-bs-original-title="" title=""><i class='bx bx-edit'></i></a></li>
